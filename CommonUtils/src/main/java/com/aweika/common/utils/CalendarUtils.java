...
public class CalendarUtils {
    ...
    public static void main(String[] args) {
        Date start = new Date(getMonthStartTime(System.currentTimeMillis(), "GMT+8:00"));
        System.out.println(start);
        Date end = new Date(getMonthEndTime(System.currentTimeMillis(), "GMT+8:00"));

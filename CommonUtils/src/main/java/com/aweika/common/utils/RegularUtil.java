...
public class RegularUtil {
    ...
    /** 中文数字 */
    public static final String CHINESE_NUMBER = "[一二三四五六七八九〇○o零十]";
    /** 中文大写数字 */
    public static final String CHINESE_NUMBER_UPPER = "[壹贰叁肆伍陆柒捌玖零〇○o十拾]";
    /** 年 */
    public static final String YEAR = "(((19|20)\\d{2})年||((19|20)\\d{2})|((一九|二〇|二○|二o|二零)"+CHINESE_NUMBER+CHINESE_NUMBER+")年|((一九|二〇|二○|二o|二零)"+CHINESE_NUMBER_UPPER+CHINESE_NUMBER_UPPER+")年)";
    /** 月 */
    public static final String MONTH = "(.{1,2}月|-\\d{1,2}|/\\d{1,2}|／\\d{1,2}|"+CHINESE_NUMBER+CHINESE_NUMBER+"月|(一十)"+CHINESE_NUMBER+"月|"+CHINESE_NUMBER_UPPER+CHINESE_NUMBER_UPPER+"月|(壹拾)"+CHINESE_NUMBER_UPPER+"月)";
    /** 日 */
    public static final String DAY = "(.{1,2}日|-\\d{1,2}|/\\d{1,2}|／\\d{1,2}|"+CHINESE_NUMBER+CHINESE_NUMBER+"日|"+CHINESE_NUMBER_UPPER+CHINESE_NUMBER_UPPER+"日|((一十)|(二十)|(三十))"+CHINESE_NUMBER+"日|((壹拾)|(贰拾)|(叁拾))"+CHINESE_NUMBER_UPPER+"日)";
...
//    [+-]?\\d+(\\.\\d+)? 普通duble
    ...
    public static void main(String[] args) {
        ...
        System.out.println(validate("9999",YEAR));
    }
}

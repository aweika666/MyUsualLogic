...
@SpringBootTest(classes={EasyExcelApplication.class})// 指定启动类
public class ApplicationTests {

    /*
    /Users/fangqizhe/Desktop/ProJects/MyUsualLogic/easyexcel-demo/target/test-classes/
     */
    @Test
    public void aaa(){
    ...
    public void complexHeadWrite() {
        ...
        // 这里 需要指定写用哪个class去写，然后写到第一个sheet，名字为模板 然后文件流会自动关闭
        EasyExcel.write(fileName, ComplexHeadData.class).sheet("远程门诊").doWrite(data());
    }
